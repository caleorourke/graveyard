  ...
  grunt.initConfig({
    ...
    concat: {
      main: {
        ...
        src: ['framework/plugins/bootstrap.min.js',
              'framework/plugins/dataTables.jquery.js',
              'framework/plugins/dataTables.bootstrap.js',
              'framework/plugins/dcjq.accordion.js',
              'framework/plugins/raphael.min.js'
              ],
